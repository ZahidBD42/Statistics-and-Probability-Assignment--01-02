...
setwd("D:\Statistics Assignment")

# Verify if the file exists
file.exists("D:\Statistics Assignment.xls")
...
get_salary_wages
# Ensure that salary_wages data has 25 points
...
# If you need exactly 25 observations, you can either take the first 25, sample 25 randomly, or apply some selection method.
# Randomly select 25 observations from the combined data
set.seed(123)  # For reproducibility
salary_wages_sample_25 <- sample(salary_wages_sample, 25, replace = FALSE)
salary_wages_sample_25
# View the sample of 28 observations
print(salary_wages_sample_25)
...
set.seed(123)  # For reproducibility
salary_wages_sample_25 <- sample(combined_salary_wages, 25, replace = FALSE)
...
cat("Frequency Distribution for Sample of 25 Observations:\n")
...
# Perform analysis on the 25 sample
print_analysis(salary_wages_sample_25, "Salary Wages Sample of 25 Observations")
...
plot_histogram(frequency_distribution_sample, "Histogram of Salary Wages Sample of 25 Observations")
